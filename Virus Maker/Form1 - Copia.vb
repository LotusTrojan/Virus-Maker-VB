...
Public Class Form1
    ...
    Sub ChangeIcon()
        ...
        MsgBox("Icon succesfully changed.", MsgBoxStyle.OkOnly, "Info")
    End Sub
    'button 1
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf ComboBox1.Text = ".exe" Then
            ...
            MsgBox("Virus succesfully generated.", MsgBoxStyle.Information, "Info")
    ...
    Public Sub CheckForUpdates()
        ...
        End If
        My.Computer.Network.DownloadFile("http://www.blackhost.xyz/programs/virusmaker/version.txt", file)
        ...
        If Not MyVer = LastVer Then
            ...
            'My.Computer.Network.DownloadFile(&q­uot;http://www.blackhost.xyz/programs/virusmaker/virusmaker.exe", "") 
